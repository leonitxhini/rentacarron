        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="mb-16">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-[11px] text-blue-600 uppercase tracking-[0.2em] font-medium">{t.home.discoverLabel}</span>
            </div>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 tracking-tight">{t.home.ourFleet}</h2>
              <div className="flex items-center gap-8 text-sm">
                ...
                <a href="https://wa.me/38348188415" className="text-green-600 hover:text-green-700 transition-colors hidden sm:flex items-center gap-2 font-medium">
                  {t.home.bookViaWhatsApp} <span className="text-lg">💬</span>
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 py-24 lg:py-36 flex flex-col md:flex-row items-end md:items-center justify-between gap-12">
          <div className="max-w-xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[10px] tracking-[0.25em] uppercase text-blue-400 font-semibold">{t.home.ctaLabel}</span>
            </div>
            <h2
            ...
            >
              {t.home.ctaDrive}<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">{t.home.ctaBook}</span>
            </h2>
      ...
      <section className="py-24 lg:py-32 bg-[#e9ecf4]">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 tracking-tight mb-4">{t.home.howItWorks}</h2>
            <p className="text-gray-500 font-light max-w-lg mx-auto">{t.home.howSubtitle}</p>
          </div>

          {/* Mobile: swipe carousel */}
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-4 -mx-6 px-6 scrollbar-hide lg:hidden">
            {[
              { step: "01", icon: CarIcon, title: t.home.step1Title, desc: t.home.step1Sub },
              { step: "02", icon: Calendar, title: t.home.step2Title, desc: t.home.step2Sub },
              { step: "03", icon: Send, title: t.home.step3Title, desc: t.home.step3Sub },
              { step: "04", icon: Key, title: t.home.step4Title, desc: t.home.step4Sub }
            ].map((s) => (
      ...
      <section className="pb-24 lg:pb-32 bg-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <p className="text-sm text-blue-500 font-semibold tracking-[0.18em] uppercase mb-4">{t.home.whyLabel}</p>
            <h2
      ...
      <section className="relative overflow-hidden py-24 lg:py-32 bg-[#e9ecf4]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 text-center">
          <div className="inline-flex items-center justify-center gap-4 mb-8">
            ...
            <span className="text-[11px] text-gray-400 uppercase tracking-[0.2em] font-medium">{t.home.reviewsVerified}</span>
            <span className="w-12 h-[1px] bg-gray-200"></span>
          </div>
          
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 tracking-tight mb-12">{t.home.reviewsTitle}</h2>
